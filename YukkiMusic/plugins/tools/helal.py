...
async def tt(_, query: CallbackQuery):
   await query.edit_message_caption(caption =f"""ٓ[ٓ❍ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐎𝐇𝐀𝐑𝐀 .](https://t.me/SourseZezoMusic)
...
async def devhelp(_, query: CallbackQuery):
   await query.edit_message_caption(caption =f"""[ٓ❍ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐎𝐇𝐀𝐑𝐀 .](https://t.me/SourseZezoMusic)\n\n[❍ | 𝐆𝐎𝐇𝐀𝐑𝐀 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐧 𝐓𝐞𝐥𝐞 .](https://t.me/SourseZezoMusic)\n\n[❍ | 𝐅𝐨𝐥𝐥𝐨𝐰 𝐓𝐡𝐞 𝐁𝐮𝐭𝐭𝐨𝐧𝐬 𝐁𝐞𝐥𝐨𝐰 .](https://t.me/SourseZezoMusic)""",
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "ᥴꫝꪖꪀꪀꫀꪶ ᧁꪮꫝꪖ𝘳ꪖ", url=f"https://t.me/SourseZezoMusic"),
                    InlineKeyboardButton(
                        "𝘴ꪊρρꪮ𝘳𝓽 ᧁꪮꫝꪖ𝘳ꪖ", url=f"https://t.me/SourseZezoMusic")
                ],[
                    InlineKeyboardButton(
                        "ᦔꫀꪜ", url=f"https://t.me/B_o_d_a_90"),
                ],[
                    InlineKeyboardButton(
                        "عـوده 𖡃", callback_data=f"ayamr"),
               ], 
